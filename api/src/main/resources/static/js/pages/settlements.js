(function () {
  ...
  $('settlement-start').value = today(-6); $('settlement-end').value = today(0);
  ...
  $('settlement-reset').onclick = () => { $('settlement-keyword').value = ''; $('settlement-status').value = ''; $('settlement-start').value = today(-6); $('settlement-end').value = today(0); load(); };
